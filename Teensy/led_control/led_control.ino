...
#endif
  FastLED.addLeds<NEOPIXEL, 6>(leds[0], NUM_LEDS_PER_STRIP);  //Right front arm
  FastLED.addLeds<NEOPIXEL, 7>(leds[1], NUM_LEDS_PER_STRIP);  //Left front arm
  FastLED.addLeds<NEOPIXEL, 8>(leds[2], NUM_LEDS_PER_STRIP);  //Right back arm
  FastLED.addLeds<NEOPIXEL, 11>(leds[3], NUM_LEDS_PER_STRIP);  //Left back arm
#ifdef standalone
	Serial.begin(9600);
#endif
}
